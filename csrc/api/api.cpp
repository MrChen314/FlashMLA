...
#include "sparse_bwd_head128_2kernels_dkv.h"
#include "sparse_bwd_head128_2kernels_fused.h"
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("sparse_prefill_bwd_head128_2kernels_dkv", &sparse_attn_bwd_head128_2kernels_dkv_interface);
    m.def("sparse_prefill_bwd_head128_2kernels_fused", &sparse_attn_bwd_head128_2kernels_fused_interface);
